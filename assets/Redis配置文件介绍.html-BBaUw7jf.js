import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as i,c as n,a as s}from"./app-2Nmlc3aW.js";const a={},t=s(`<h1 id="redis配置文件介绍" tabindex="-1"><a class="header-anchor" href="#redis配置文件介绍"><span>Redis配置文件介绍</span></a></h1><h2 id="units单位" tabindex="-1"><a class="header-anchor" href="#units单位"><span>Units单位</span></a></h2><ol><li>redis默认单位的度量为byte，而不是bit，这点我们需要注意一下</li><li>计量单位对大小写不敏感</li></ol><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code># Note on units: when memory size is needed, it is possible to specify
