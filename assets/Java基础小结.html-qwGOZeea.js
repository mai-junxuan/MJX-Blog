import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as a,a as e}from"./app-2Nmlc3aW.js";const t={},p=e(`<h1 id="标识符" tabindex="-1"><a class="header-anchor" href="#标识符"><span>标识符</span></a></h1><h2 id="标识符和关键字的区别是什么" tabindex="-1"><a class="header-anchor" href="#标识符和关键字的区别是什么"><span>标识符和关键字的区别是什么？</span></a></h2><p>标识符就是我们使用的对象或者变量的名字，关键字就是被Java作为特殊标识的单词。</p><h2 id="java语言的关键字" tabindex="-1"><a class="header-anchor" href="#java语言的关键字"><span>Java语言的关键字</span></a></h2><h3 id="访问控制" tabindex="-1"><a class="header-anchor" href="#访问控制"><span>访问控制</span></a></h3><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>1. private:仅本类可以访问    
