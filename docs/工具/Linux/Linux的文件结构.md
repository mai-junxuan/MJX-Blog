...
![image-20220905194910182](https://cdn.jsdelivr.net/gh/mai-junxuan/Cloud-image/image/202209051956663.png)
...
![image-20220905194928297](https://cdn.jsdelivr.net/gh/mai-junxuan/Cloud-image/image/202209051956368.png)
...
![image-20220905194943467](https://cdn.jsdelivr.net/gh/mai-junxuan/Cloud-image/image/202209051956293.png)

而c打头的文件则是硬件设备，我们不妨键入 `ll /dev`查看一下，如下图所示的bus总线，以及cpu等这些都是硬件设备

![image-20220905194953850](https://cdn.jsdelivr.net/gh/mai-junxuan/Cloud-image/image/202209051956664.png)
...
![image-20220905195033612](https://cdn.jsdelivr.net/gh/mai-junxuan/Cloud-image/image/202209051956286.png)
...
![image-20220905195053633](https://cdn.jsdelivr.net/gh/mai-junxuan/Cloud-image/image/202209051956218.png)
...
![image-20220905195113144](https://cdn.jsdelivr.net/gh/mai-junxuan/Cloud-image/image/202209051956610.png)

了解了根目录之后，我们再来介绍一下根目录下对应的文件夹，首先是/bin，我们日常使用Linux的时候都会用到ls、cat、touch、mkdir等命令，其实这些命令都是一些可执行文件，存放于bin目录下，如下图

![image-20220905195127851](https://cdn.jsdelivr.net/gh/mai-junxuan/Cloud-image/image/202209051957179.png)

接下来是/boot，这个目录存放的基本都是Linux开机会用到配置文件，像Linux kerne常用到的文件名`vmlinuz`就会存放在这个文件夹下

![image-20220905195141265](https://cdn.jsdelivr.net/gh/mai-junxuan/Cloud-image/image/202209051957190.png)

接下来是/dev，这个文件夹基本存放的都是硬件设备，我们都知道Linux主张一切皆文件，所以所有的鼠标、键盘、硬盘的设备信息都是存放在这个文件夹下

![image-20220905195204472](https://cdn.jsdelivr.net/gh/mai-junxuan/Cloud-image/image/202209051957806.png)
...
![image-20220905195219201](https://cdn.jsdelivr.net/gh/mai-junxuan/Cloud-image/image/202209051957299.png) 

同样的我们也能够在usr/bin目录下看到这个指令

![image-20220905195229225](https://cdn.jsdelivr.net/gh/mai-junxuan/Cloud-image/image/202209051956803.png)
...
![image-20220905195258808](https://cdn.jsdelivr.net/gh/mai-junxuan/Cloud-image/image/202209051956629.png)
...
![image-20220905195318293](https://cdn.jsdelivr.net/gh/mai-junxuan/Cloud-image/image/202209051956614.png)
...
![image-20220905195349968](https://cdn.jsdelivr.net/gh/mai-junxuan/Cloud-image/image/202209051956701.png)
...
![image-20220905195404716](https://cdn.jsdelivr.net/gh/mai-junxuan/Cloud-image/image/202209051956032.png)
...
![image-20220905195422099](https://cdn.jsdelivr.net/gh/mai-junxuan/Cloud-image/image/202209051956109.png) 
...
![image-20220905195433739](https://cdn.jsdelivr.net/gh/mai-junxuan/Cloud-image/image/202209051956155.png)
...
![image-20220905195451605](https://cdn.jsdelivr.net/gh/mai-junxuan/Cloud-image/image/202209051956371.png)
...
![image-20220905195506527](https://cdn.jsdelivr.net/gh/mai-junxuan/Cloud-image/image/202209051956106.png)

所以我们使用别的账户可以进入路径，但是无法读写该文件如下图 

![image-20220905195523013](https://cdn.jsdelivr.net/gh/mai-junxuan/Cloud-image/image/202209051956548.png)
...
以下这张表格就说明了操作文件夹下某些文件所需的最低权限，可以看到像删除、复制等这些无需读取文件内容的操作，文件所对应的文件夹甚至不一定需要rw的权限。用上面抽屉和文件的例子来说，我们删除完完全全可以看不到抽屉内部文件的具体的内容，复制文件不需要知道文件夹内有什么文件，我们完完全全可以瞎摸出来放到别的目录。
 ...
 ![在这里插入图片描述](https://cdn.jsdelivr.net/gh/mai-junxuan/Cloud-image/image/202209051956835.png)
